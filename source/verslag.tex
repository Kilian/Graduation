...
\begin{document}
  ...
  \addcontentsline{toc}{chapter}{Voorwoord}
    ...
    - zelf veel aandacht voor usability
    - dit combineren met technische achtergrond
    - wakoopa ideale plek, direct testen en implementeren van verbeteringen
    - github en latex als persoonlijk experiment geslaagd
    - blij met de hulp van de lab test participanten, geinterviewden en begeleiders, hebben geholpen met vormen van scriptie

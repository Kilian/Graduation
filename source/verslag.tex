...
\begin{document}
  ...
  \section{Wat zeggen andere onderzoeken op het gebied van usability en sociale netwerken?}
    ...
    \subsection{Externe onderzoeken}
      Er zijn een drietal onderzoeksinstellingen die veel onderzoek doen naar usability en participatie op social networks. Veel van hun papers worden dan ook gerefereerd in dit verslag. De drietal instellingen zijn:
        \begin{itemize}

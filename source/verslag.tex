...
[TODO]
  ...
  \addcontentsline{toc}{chapter}{Voorwoord}
    ...
    Deze afstudeeropdracht heb ik in bijna volledige openheid in Git versiebeheer op GitHub gemaakt, en daar dagelijks mijn wijzigingen opgezet. Dit zorgte ten eerste voor adequate back-ups, maar ook voor een ideaal logboek van mijn veranderingen. Ook het maken van dit document in \LaTeX was een experiment, omdat ik hier nog niet bekend mee was. Wat mij betreft is dit geslaagd. \LaTeX is relatief gemakkelijk te begrijpen voor developers en neemt ontzettend veel werk uit handen, zoals bijvoorbeeld het bijhouden van referenties (binnen een document, en naar externe bronnen), het maken van indices, typografie en documentstructuur.

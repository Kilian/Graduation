\documentclass[a4paper, 10pt, pdftex]{report}
  ...
  \linebreak \small{Deelname op learning networks verhogen mets gebruiksvriendelijkheid} \linebreak \linebreak \emph{Scriptie}}
...
\begin{document}
  ...
  en gebruiksvriendelijkheid voor websites hebben (volgens velen terecht) een veel grotere nadruk gekregen dan daarvoor. Hoewel mensen
 ...
 Een learning network heeft een drietal eigenschappen. Het beheerd zichzelf, het organiseert zichzelf en het reguleert zichzelf. Deze eigenschappen uiten zichzelf in de opgesomde lijst van functionaliteiten. Deze functionaliteiten stellen de gebruikers in staat zelfstandig bezig te zijn, zonder dat daar administratie of moderatie bij benodigd is.
  ...
  \subsection*{Afbakening van het onderzoek}
  \addcontentsline{toc}{section}{Afbakening van onderzoek}

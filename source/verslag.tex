...
Momenteel toont Wakoopa enkel een melding dat een profiel nog niet compleet is, maar geeft niet aan wat de vervolgstappen zijn. De implementatie van een progressiemeter kan er voor zorgen dat meer gebruikers hun profiel invullen.
  ...
  \section{Interne onderzoeken bij Wakopa}
    ...
    \paragraph{Usability Review \citet{Alfrink2008}}
    ...
    Soorgelijke doortastende dingen zijn te doen met andere punten van een site. Zo kan je bij zoekfunctionaliteit bijvoorbeeld voorspellen waar de gebruiker naar wilt zoeken afhankelijk van het soort pagina waar hij of zij op zitten. Wanneer een gebruiker op een andere gebruikerspagina zit, zal hij of zij waarschijnlijk naar gebruikers zoeken, terwijl wanneer je op een itempagina waarschijnlijk naar andere items op zoek bent. Op een globale overzichtspagina kan je ook persoonlijke informatie kwijt, zoals bij categorie\"en de applicaties die jij in die categorie gebruikt.

    \paragraph{Usability Review \citet{Hoekman2008}}

%miskeeto
%- highlight benefits (external research supports this!) on homepage
%- group benefits together, make it a block (1 header, or different background colour) on homepage
%- derde niveau tabjes/ left side list nav weghalen
%- standardize yellow colour (message notices?)

    \paragraph{Usability Review \citet{Timmerman2008}}
